		...
		<div class="log_c">
            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td>用户名</td>
                <td>
					<form:input id="username" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" 
                    placeholder="邮箱/用户名/手机号" class="l_user" /> 
				</td>
              </tr>
              <tr height="70">
                <td>密&nbsp; &nbsp; 码</td>
                <td>
                    ...
                    placeholder="请输入密码" class="l_pwd"   />
					<form:errors path="*" style="color:red; font-weight:bold;" id="msg" cssClass="errors" element="div" htmlEscape="false" />
				</td>
              </tr>
              <tr>
              	<td>&nbsp;</td>
              ...
              <tr height="60">
                ...
                <td>
					...
					<input class="log_btn" accesskey="l" value="登陆" type="submit" />
				</td>
              </tr>
            </table>
            </form:form>
